...
class PaymentDAO:
    ...
    async def approve_by_operator(
        ...
        *,
        ...
        if not payment:
            raise NotFoundError("Р СџР В»Р В°РЎвЂљРЎвЂР В¶ Р Р…Р Вµ Р Р…Р В°Р в„–Р Т‘Р ВµР Р…")

        if payment.status != PaymentStatus.ON_REVIEW:
            raise InvalidStateError("Р СџР В»Р В°РЎвЂљРЎвЂР В¶ Р Р…Р Вµ Р Р…Р В° Р С—РЎР‚Р С•Р Р†Р ВµРЎР‚Р С”Р Вµ")
