...
class OperatorService:
    ...
    Р СџРЎС“Р В±Р В»Р С‘РЎвЂЎР Р…РЎвЂ№Р Вµ Р СР ВµРЎвЂљР С•Р Т‘РЎвЂ№ Р С—РЎР‚Р С‘Р Р…Р С‘Р СР В°РЎР‹РЎвЂљ tg_id (Telegram user id),


    Р Р…Р С• Р Р† operator_shifts Р С—Р С‘РЎв‚¬Р ВµР С users.id (int).
    ...
    async def _get_user_id_by_tg(self, tg_id: int) -> int:
        ...
        if not user:
            ...
            # Р ВµРЎРѓР В»Р С‘ РЎС“ РЎвЂљР ВµР В±РЎРЏ Р ВµРЎРѓРЎвЂљРЎРЉ create/get_or_create РІР‚вЂќ Р С—Р С•Р Т‘РЎРѓРЎвЂљР В°Р Р†РЎРЉ Р ВµР С–Р С•
