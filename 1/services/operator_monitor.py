        ...
        for shift in stale_shifts:
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    "РІРЏВ± Р РЋР СР ВµР Р…Р В° Р В·Р В°Р С”РЎР‚РЎвЂ№РЎвЂљР В° Р В°Р Р†РЎвЂљР С•Р СР В°РЎвЂљР С‘РЎвЂЎР ВµРЎРѓР С”Р С‘ Р С‘Р В·-Р В·Р В° Р Р…Р ВµР В°Р С”РЎвЂљР С‘Р Р†Р Р…Р С•РЎРѓРЎвЂљР С‘",
...
async def operator_monitor_loop(
    ...
    while True:
        ...
        try:
            ...
            logger.exception("РІСњРЉ Operator monitor crashed")
