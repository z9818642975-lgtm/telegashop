...
class StockService:
    ...
    async def _warehouse_for_order(self, order):
        ...
        if not wh:
            ...
            raise ValueError("Р СњР ВµРЎвЂљ РЎРѓР С”Р В»Р В°Р Т‘Р В° Р С•Р С—Р ВµРЎР‚Р В°РЎвЂљР С•РЎР‚Р В°")
    ...
    async def reserve_for_order(self, order, items, bot=None):
        ...
        for it in items:
            ...
            if have < it["qty"]:
                ...
                raise ValueError("Р СњР ВµР Т‘Р С•РЎРѓРЎвЂљР В°РЎвЂљР С•РЎвЂЎР Р…Р С• РЎвЂљР С•Р Р†Р В°РЎР‚Р В° Р Р…Р В° РЎРѓР С”Р В»Р В°Р Т‘Р Вµ")
    ...
    async def move_reservation(self, order_id: int, new_operator_tg_id: int):
        ...
        if not new_wh:
            ...
            raise ValueError("Р СњР ВµРЎвЂљ РЎРѓР С”Р В»Р В°Р Т‘Р В° Р Р…Р С•Р Р†Р С•Р С–Р С• Р С•Р С—Р ВµРЎР‚Р В°РЎвЂљР С•РЎР‚Р В°")
